@php($svg = explode('/', $image))
@switch(explode('.',end($svg))[0])
    @case('vide')
    <div class="section-separator-svg">
    ...
    @default
    <img src="{{image_url(array_values($sValue)[0]['image'])}}" class="section-separator-image" alt="">
@endswitch
