...
@else
    @include('widget.banner.banner', ['banner' => 'account', 'value' => 'account'])
@endif
<div class="card mb-4 shadow-sm" @include('elements.string-aos')>
    <div class="card-body">
        <div class="row">
            <div class="col-xl-2 col-md-3 text-center">
                <img src="{{ $user->getAvatar(150) }}"width="150"  class="rounded mb-3 img-fluid mx-auto" alt="{{ $user->name }}">
...
@if($canVerifyEmail)
    ...
    <div class="alert alert-warning justify-content-between mb-4" role="alert">
        <div>
...
<div class="row" @include('elements.string-aos')>
    <div class="col-md-6">
                        ...
                        <form action="{{ route('profile.name') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                       id="nameInput" name="name" value="{{ old('name', $user->name ?? '') }}" required>
