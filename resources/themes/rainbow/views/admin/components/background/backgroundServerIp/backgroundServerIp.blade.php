@php
    ...
    $id_background = isset($id_background) && $id_background ? $id_background :  random_int(1,9999);
        ...
        $banner = ['key'=>'backgroundServerIp', 'balise' => 1];
        $items = ['key'=> 'backgroundServerIp',
                                'filedsBuilder' => [
                                    ['type'=>'checkbox','value' => 'hidden'],
                                ]];

        $backgroundPage = [
                        'key'=> 'backgroundServerIp',
                        'value' => 'background',
                        'is_aos' => false,
                        'filedsBuilder' => [
...
<div class="col-lg-12 h-auto mb-4 sortable-item builder-background js-detect-background">
    <input type="hidden" class="js-detect-page js-detect-background-id" name="{page}[background][backgroundServerIp]"
           value="{{$id_background_name}}">
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h4 class="card-title mb-0">Background Server Ip</h4>
