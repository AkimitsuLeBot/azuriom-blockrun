@php
    ...
    $items = ['key'=> 'top_buyer',
                            'filedsBuilder' => [
                                ...
                                ['type'=>'checkbox','value' => 'price_hidden'],
                                ['type'=>'range','label' => trans('theme::widget.top_buyer.item.label.maxPlayer'), 'key'=>'quantity','value'=>'quantity','default' =>'1','min'=>'0', 'max'=> '10', 'step'=>'1'],
