                    ...
                    <div class="offset-md-4 col-md-4">
                        <div class="card card-body">
                            <a href="{{ $link }}" target="_blank">
                                <span class="display-1 d-inline-block mb-2"><i class="{{ $icon }}"></i></span>
                    ...
                    <div class="col-md-4">
                        <div class="card card-body">
                            <a href="{{ $linux }}" target="_blank" class="text-reset d-block">
                                <p class="display-1 d-inline-block mb-2">
                    ...
                    <div class="col-md-4">
                        <div class="card card-body">
                            <a href="{{ $windows }}" target="_blank" class="text-reset d-block">
                                <span class="display-1 d-inline-block mb-2"><i class="bi bi-windows"></i></span>
                    ...
                    <div class="col-md-4">
                        <div class="card card-body">
                            <a href="{{ $mac }}" target="_blank" class="text-reset d-block">
                                <span class="display-1 d-inline-block mb-2"><i class="bi bi-apple"></i></span>
