        ...
        <tbody>
            ...
            @foreach($guild_ranking as $guild_name => $guild_rank)
                <tr>
                    ...
                    <td>
                        <a class="mx-1" data-bs-toggle="collapse" href="#collapse-guild-{{$loop->index}}" role="button" aria-expanded="false" aria-controls="collapse-guild-{{$loop->index}}"><i class="bi bi-eye-fill"></i></a>
                    </td>
                </tr>
