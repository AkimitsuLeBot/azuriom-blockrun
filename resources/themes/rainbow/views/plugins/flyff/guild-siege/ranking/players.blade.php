        ...
        <tbody>
            ...
            @foreach($player_ranking as $player_name => $player_rank)
                <tr>
                    ...
                    <td>
                        <a class="mx-1" data-bs-toggle="collapse" href="#collapse-player-{{$loop->index}}" role="button" aria-expanded="false" aria-controls="collapse-player-{{$loop->index}}"><i class="bi bi-eye-fill"></i></a>
                    </td>
                </tr>
