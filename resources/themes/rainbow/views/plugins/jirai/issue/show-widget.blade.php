<div class="card mt-5 mb-5" @include('elements.string-aos', ['pageAos' => 'jirai', 'itemAos'=>'issues-show'])>
    <div class="card-header">
        <img class="rounded float-start me-4" src="{{ $issue->user->getAvatar() }}" alt="{{ $issue->user->name }}"
             height="55">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <a class="btn btn-danger" href="{{ route('jirai.issues.destroy', ['issue' => $issue->id]) }}"
    ...
    <form action="{{ route('jirai.messages.store') }}"
        ...
        <div class="card shadow-sm mb-3">
            <div class="card-header">
                ...
                <button type="submit" class="btn btn-primary float-end">{{ trans('jirai::messages.answer') }}</button>
            </div>
