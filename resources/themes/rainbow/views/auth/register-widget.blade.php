...
@else
    @include('widget.banner.banner', ['banner' => 'register', 'value' => 'register'])
@endif
            ...
            @if($registerConditions !== null)
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input @error('conditions') is-invalid @enderror" type="checkbox"
                               name="conditions" id="conditions" @checked(old('conditions'))>
