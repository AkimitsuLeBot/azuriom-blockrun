    ...
    */
    ...
    'settings' => [
        ...
        'auth' => [
            ...
            'user_avatar' => 'Разрешите пользователям загружать свой собственный аватар в профиль',
    ...
    'servers' => [
        ...
        'azlink' => [
            ...
            'auth' => 'Чтобы автоматически регистрировать пользователей на сайте, вы можете включить интеграцию вашей системы аутентификации (AuthMe и т. д.) в настройках AzLink.',
